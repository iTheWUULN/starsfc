            ...
            channel.send({
                content: `<@${member.user.id}>`, embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .setDescription('• Merhaba Stars Team kullanıcısı, seni sunucumuza güvenle alabilmek için altta bulunan yazıyı butona tıklayarak yazman gerekiyor.')
