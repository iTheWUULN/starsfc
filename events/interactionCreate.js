...
name: Discord.Events.InteractionCreate,
    ...
    readdirSync('./commands').forEach(f => {
      ...
      if(interaction.commandName.toLowerCase() === cmd.name.toLowerCase()) {
        ...
        if(!rulesisread) {
          ...
          .setTitle("> ⚠️・Kuralları kabul etmek için **Kabul Ediyorum.** butonuna tıklayın!\n> <:yildiz:1039607072783868044>・Ama bunu yapmadan önce bi linklere göz atmanı isterim!")
          .setDescription("\n\n**<:links:1039607057923461181> Linkler**\n> <:file:1044325532566822913>・**Botun kullanım koşulları: [Tıkla](https://github.com/araschain/Stars Team-Bot-Terms-Of-Service)**\n> <:newmember:1044325552007422052>・**Botun gizlilik politikası: [Tıkla](https://github.com/araschain/Stars Team-Bot-Privacy-Policy)**")
          .setColor('Blue')
  ...
  .setCustomId("ooeoeo"))
      ...
      .setTitle("> ⚠️・Kuralları kabul ettiğin için teşekkürler artık botun tadını çıkarabilirsin!")
      .setColor('Blue')
    ...
    if(interaction.customId === idFind("kayitol")) {
      ...
      .setTitle('Stars Team - Kayıt Menüsü!')
  ...
  if(interaction.isModalSubmit()) {
    if (interaction.customId === 'kayitform') {
     ...
     if (interaction.customId === 'form') {
      ...
      if (!onay) interaction.reply({ content: "❌ | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!logg) interaction.reply({ content: "❌ | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!botRol) interaction.reply({ content: "❌ | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!devRol) interaction.reply({ content: "❌ | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!adminRol) interaction.reply({ content: "❌ | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!botekle) interaction.reply({ content: "❌ | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!ayrildiLog) interaction.reply({ content: "❌ | Botlist sistemi ayarlanmamış!", ephemeral: true })
 ...
 .addComponents(
  ...
  interaction.reply({ content: `✅ **|** Senin için bir tane destek kanalı ${channel} oluşturldu.`, ephemeral: true })
...
if(interaction.customId === 'giriscikis'){
  ...
  if (sayacmessage && sayacmessageDate) {
      ...
      .setDescription(`❌ | Bu sistem <t:${parseInt(sayacmessageDate.date / 1000)}:R> önce açılmış!`)
  ...
  .setDescription("✅ **|** Giriş çıkış mesajı aktif edildi!")
  .addFields([
    {
    ...
    if(interaction.customId === "rol_everyone") {
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <a:6107dmag:1208394127709052958> | Stars Team - Moderasyon Menüsü!")
          .addFields(
        { name: "**> 🔴 </ban-list:1039964202003079243>**", value: `> ⚙️ **Banlı kullanıcıları gösterir!**`, inline: true },
        { name: "**> 🔴 </ban:1039964202003079244>**", value: `> ⚙️ **Bir üyeyi yasaklarsın!**`, inline: true  },
        { name: "**> 🔴 </emojiler:1039964202003079250>**", value: `> ⚙️ **Emojileri gösterir!**`, inline: true  },
        { name: "**> 🔴 </forceban:1039964202045030420>**", value: `> ⚙️ **ID ile kullanıcı banlarsın!**`, inline: true  },
        { name: "**> 🔴 </giriş-çıkış:1039964202045030424> | </giriş-çıkış-kapat:1039964202045030423>**", value: `> ⚙️ **Giriş çıkış kanalını ayarlarsın!**`, inline: true  },
		{ name: "**> 🔴 </giriş-çıkış-mesaj:1067118408816132207>**", value: `> ⚙️ **Giriş çıkış mesajını ayarlarsınız!**`, inline: true  },
        { name: "**> 🔴 </kanal-açıklama:1039964202045030426>**", value: `> ⚙️ **Kanal açıklamasını değiştirirsin!**`, inline: true  },
        { name: "**> 🔴 </kick:1039964202095349880>**", value: `> ⚙️ **Bir üyeyi atarsın!**`, inline: true  },
        { name: "**> 🔴 </küfür-engel:1039964202095349883>**", value: `> ⚙️ **Küfür engel sistemini açıp kapatırsın!**`, inline: true  },
        { name: "**> 🔴 </oto-rol:1039964202095349887> | </oto-rol-kapat:1039964202095349886>**", value: `> ⚙️ **OtoRol'ü ayarlarsın!!**`, inline: true  },
        { name: "**> 🔴 </oto-tag:1039964202095349889> | </oto-tag-kapat:1039964202095349888>**", value: `> ⚙️ **OtoTag'ı ayarlarsın!**`, inline: true  },
        { name: "**> 🔴 </oylama:1039964202149879908>**", value: `> ⚙️ **Oylama başlatırsın!**`, inline: true  },
        { name: "**> 🔴 </reklam-engel:1039964202149879911>**", value: `> ⚙️ **Reklam engellemeyi açarsın!**`, inline: true  },
        { name: "**> 🔴 </rol-al:1039964202149879912>**", value: `> ⚙️ **Rol alırsın!**`, inline: true  },
      { name: "**> 🔴 </timeout-sistemi:1048961342540877907>**", value: `> ⚙️ **Timeout sistemini ayarlarsın!**`, inline: true  },
      { name: "**> 🔴 </timeout-sistemi-sıfırla:1048961342540877906>**", value: `> ⚙️ **Timeout sistemini sıfırlarsın!**`, inline: true  },
      { name: "**> 🔴 </timeout:1048961342540877908>**", value: `> ⚙️ **Belirlenen kullanıcıya timeout atar.**`, inline: true  },
      { name: "**> 🔴 </untimeout:1048961342540877909>**", value: `> ⚙️ **Belirlenen kullanıcının timeoutunu kaldırır.**`, inline: true  },
                  )
          .setColor("Random")
      ...
      .setTitle("> <a:6107dmag:1208394127709052958> | Stars Team - Moderasyon 2 Menüsü!")
      .addFields(
        { name: "**> 🔴 </rol-oluştur:1039964202149879913>**", value: `> ⚙️ **Rol oluşturursun!**`, inline: true  },
        { name: "**> 🔴 </rol-ver:1039964202149879914>**", value: `> ⚙️ **Rol verirsin!**`, inline: true  },
        { name: "**> 🔴 </sa-as:1039964202149879915>**", value: `> ⚙️ **Selam sistemini ayarlarsın!**`, inline: true  },
        { name: "**> 🔴 </sil:1039964202149879917>**", value: `> ⚙️ **Mesaj silersin!**`, inline: true  },
        { name: "**> 🔴 </unban:1039964202359603301>**", value: `> ⚙️ **Bir üyenin yasağını kaldırırsın!**`, inline: true  },
        { name: "**> 🔴 </buton-rol:1039964202003079246>**", value: `> ⚙️ **Buton rol sistemini ayarlarsın!**`, inline: true  },
        { name: "**> 🔴 </capslock-koruma:1039964202003079247>**", value: `> ⚙️ **CapsLock koruma sistemini ayarlarsın!**`, inline: true  },
        { name: "**> 🔴 </görsel-engel:1039964202045030422> | </görsel-engel-kapat:1039964202045030421>**", value: `> ⚙️ **Görsel engelleme sistemini ayarlarsın!**`, inline: true  },
        { name: "**> 🔴 </yavaş-mod:1039964202359603303>**", value: `> ⚙️ **Yavaş modu ayarlarsın!**`, inline: true  },
      { name: "**> 🔴 </sunucu-kur:1042791957463846972>**", value: `> ⚙️ **Otomatik sunucu kurar!**`, inline: true  },
      { name: "**> 🔴 </mod-log ayarla:1043079840695324722>**", value: `> ⚙️ **Moderasyon Logunu ayarlarsın!**`, inline: true  },
      { name: "**> 🔴 </yasaklı-kelime:1046365423945400420> | </yasaklı-kelime-kapat:1046366035315531796>**", value: `> ⚙️ **Yasaklı Kelimeyi ayarlarsın!**`, inline: true  },
      { name: "**> 🔴 </kanal-aç:1046452705482248272>**", value: `> ⚙️ **Kanalı mesaj gönderimine açarsın!**`, inline: true  },
      { name: "**> 🔴 </kanal-kilitle:1046452705482248273>**", value: `> ⚙️ **Kanalı mesaj gönderimine kapatırsın!**`, inline: true  },
	  { name: "**> 🔴 </resimli-giriş-çıkış:1068595212705878137>**", value: `> ⚙️ **Resimli giriş çıkış'ı ayarlarsın!**`, inline: true  }
      )
      .setColor("Random")
      ...
      const embed = new Discord.EmbedBuilder()
      .setTitle("> | Stars Team - Moderasyon Menüsü!")
      .addFields(
        { name: "**> 🔴 </ban-list:1039964202003079243>**", value: `> ⚙️ **Banlı kullanıcıları gösterir!**`, inline: true },
        { name: "**> 🔴 </ban:1039964202003079244>**", value: `> ⚙️ **Bir üyeyi yasaklarsın!**`, inline: true  },
        { name: "**> 🔴 </emojiler:1039964202003079250>**", value: `> ⚙️ **Emojileri gösterir!**`, inline: true  },
      ...
      .setCustomId("kayıt_"+interaction.user.id),
          ...
          .setTitle("> | Stars Team - Kayıt Menüsü!")
          .addFields(
            { name: "**> 🔴 </kayıt-sistemi:1063887700786159709>**", value: `> ⚙️ **Kayıt sistemini ayarlarsın!**`, inline: true },
          { name: "**> 🔴 </kayıt-sistemi-kapat:1063887700786159708>**", value: `> ⚙️ **Kayıt sistemini kapatırsın**`, inline: true },
			  { name: "**> 🔴 </kayıt-isim-sıfırla:1063887700786159708>**", value: `> ⚙️ **Kayıt sistemindeki ismini sıfırlarsın!**`, inline: true }
                  )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [kayıt23, row2]})
        }
      ...
      .setCustomId("kayıt_"+interaction.user.id),
          ...
          const embed = new EmbedBuilder()
          .setTitle("> | Stars Team - Kullanıcı Menüsü!")
          .addFields(
            { name: "**> 🔴 </avatar:1039964202003079242>**", value: `> ⚙️ **Avatarına bakarsın!**`, inline: true },
            { name: "**> 🔴 </afk:1039964202003079241>**", value: `> ⚙️ **Afk olursun!**`, inline: true  },
            { name: "**> 🔴 </emoji-yazı:1039964202003079249>**", value: `> ⚙️ **Bota emoji ile yazı!**`, inline: true  },
            { name: "**> 🔴 </istatistik:1039964202045030425>**", value: `> ⚙️ **Bot istatistikleri!**`, inline: true  },
            { name: "**> 🔴 </kurucu-kim:1039964202095349882>**", value: `> ⚙️ **Sunucunun kurucusunu gösterir!**`, inline: true  },
            { name: "**> 🔴 </ping:1039964202149879909>**", value: `> ⚙️ **Botun pingini gösterir!**`, inline: true  },
            { name: "**> 🔴 </yardım:1039964202359603302>**", value: `> ⚙️ **Yardım menüsü!**`, inline: true  },
            { name: "**> 🔴 </davet:1039964202003079248>**", value: `> ⚙️ **Botun davet linki!**`, inline: true  },
            { name: "**> 🔴 </kullanıcı-bilgi:1039964202095349881>**", value: `> ⚙️ **Kullanıcı bilgisi!**`, inline: true  },
            { name: "**> 🔴 </random-anime:1039964202149879910>**", value: `> ⚙️ **Random Anime atar.**`, inline: true  },
            { name: "**> 🔴 </say:1039964202149879916>**", value: `> ⚙️ **Sunucuda kaç üye olduğunu gösterir.**`, inline: true  },
            { name: "**> 🔴 </sunucupp:1069330554278912091>**", value: `> ⚙️ **Sunucunun avatarına bakarsın!**`, inline: true  },
            { name: "**> 🔴 </sunucu-bilgi:1051458065578348546>**", value: `> ⚙️ **Sunucu bilgilerini gösterir.**`, inline: true  },
          { name: "**> 🔴 </ayarlar:1053000987285127249>**", value: `> ⚙️ **Sunucu ayarlarını gösterir.**`, inline: true  }
                  )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [kayıt23, row2]})
        }
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setAuthor({ name: "Stars Team Sistemler Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
          .setTitle("・Hangi komutlarım hakkında bilgi almak istiyorsan o butona bas!")
          .setDescription("*Herşey Stars Team için...*")
          .setColor('Blue')
        ...
        if (interaction.customId == "korumasystem_"+interaction.user.id) {
          const embed = new Discord.EmbedBuilder()
          .setTitle("> | Stars Team - Koruma Menüsü!")
          .addFields(
            { name: "**> 🔴 </hesap-koruma:1069205098888171560>**", value: `> ⚙️ **Hesap koruma sistemini açarsın!**`, inline: true },
            { name: "**> 🔴 </koruma-log:1069205098888171561>**", value: `> ⚙️ **Koruma logunu ayarlarsın!**`, inline: true }
          )
          .setColor("Random")
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> | Stars Team - Botlist Menüsü!")
          .addFields(
            { name: "**> 🔴 </botlist-ayarla:1039964202003079245>**", value: `> ⚙️ **Botlist sistemini ayarlarsın!**`, inline: true }
          )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
      ...
      const embed = new Discord.EmbedBuilder()
      .setTitle("> | Stars Team - Özel Oda Menüsü!")
      .addFields(
        { name: "**> 🔴 </özel-oda-sistemi:1041738859572105318>**", value: `> ⚙️ **Özel Oda Sistemini ayarlarsın!**`, inline: true },
        { name: "**> 🔴 </özel-oda-sil:1041738859572105317>**", value: `> ⚙️ **Özel Odanı silersin!**`, inline: true },
        { name: "**> 🔴 </özel-oda-kullanıcı-menü:1041738859572105316>**", value: `> ⚙️ **Özel Odana kullanıcı eklersin!**`, inline: true }
      )
      .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> | Stars Team - Ticket Menüsü!")
          .addFields(
            { name: "**> 🔴 </destek-sistemi:1065718561311567995>**", value: `> ⚙️ **Destek sistemini ayarlarsın!**`, inline: true },
            { name: "**> 🔴 </destek-sistemi-sıfırla:1065718561311567994>**", value: `> ⚙️ **Destek sistemini sıfırlarsın!.**`, inline: true  }
                  )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> | Stars Team - Level Menüsü!")
          .addFields(
            { name: "**> 🔴 </level-sistemi:1053000987285127254>**", value: `> ⚙️ **Level sistemini açarsın!**`, inline: true },
            { name: "**> 🔴 </level-log ayarla:1053000987285127252>**", value: `> ⚙️ **Level logu ayarlarsın!**`, inline: true },
            { name: "**> 🔴 </level:1053000987285127255>**", value: `> ⚙️ **Levelini görüntülersin!**`, inline: true },
            { name: "**> 🔴 </level-ekle:1053000987285127251>**", value: `> ⚙️ **Level eklersin!**`, inline: true },
            { name: "**> 🔴 </level-kaldır:1053000987285127253>**", value: `> ⚙️ **Level kaldırırsın!**`, inline: true },
            { name: "**> 🔴 </level-arka-plan:1053750137077387334>**", value: `> ⚙️ **Level arkaplanını ayarlarsın!**`, inline: true },
            { name: "**> 🔴 </level-sıralaması:1053000987285127250>**", value: `> ⚙️ **Level sıralamasını görüntülersin!**`, inline: true }
          )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> | Stars Team - Captcha Menüsü!")
          .addFields(
            { name: "**> 🔴 </captcha-sistemi:1064125585166708918>**", value: `> ⚙️ **Captcha sistemini açarsın!**`, inline: true },
            { name: "**> 🔴 </captcha-görüntüle:1064125585166708917>**", value: `> ⚙️ **Captcha istatistiklerini görüntülersin!**`, inline: true },
			{ name: "**> 🔴 </captcha-sistemi-sıfırla:1068963862600220732>**", value: `> ⚙️ **Captcha sistemini sıfırlarsın!**`, inline: true }
          )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
        ...
        interaction.deferUpdate();
          ...
          if (interaction.customId === "muteonay_"+interaction.user.id) {
            ...
            if (!ucanEssek) return interaction.reply("❌ | Üyeyi bulamadım.")
            ucanEssek.roles.add(muterol)
            const embed = new EmbedBuilder()
            .setDescription(`✅ | Başarılı bir şekilde <@!${kullanıcı}> isimli kişiye mute atıldı.
        `)
          ...
          if (interaction.customId === "mutered_"+interaction.user.id) {
            ...
            const embed = new EmbedBuilder()
            .setDescription(`✅ | Başarılı bir şekilde mute iptal edildi.
        `)
            interaction.update({embeds: [embed], components: [row, dmb]})
          }
            ...
            **__${interaction.guild.name} Sunucu Kuralları__**                                    
            ...
            interaction.guild.channels.create({name: "💬・sohbet", type: ChannelType.GuildText}).then(sohbet => {
                ...
                .setTitle('Stars Team Bot - İyi günler diler.')
            ...
            if (interaction.customId === "sunucukurred_"+interaction.user.id) {
              interaction.update({content: `✅ | Başarılı bir şekilde sunucu kurma iptal edildi!`, embeds: [], components: []})
            } 
      ...
      .setTitle('Stars Team - Özel Oda Kullanıcı Ekleme!')
        ...
        .setTitle('Stars Team - Özel Oda Kullanıcı Çıkarma!')
          ...
          if (interaction.customId === "unban_everyone") {
            ...
            if(!interaction.member.permissions.has(botlistadmin)) return interaction.reply({content: `❌ | Bu butonu sadece <@&${botlistadmin}> yetkisi olanlar kullanabilir!`, ephemeral: true})
        ...
        if (interaction.customId === "reddet_everyone") {
          ...
          if(!interaction.member.permissions.has(botlistadmin)) return interaction.reply({content: `❌ | Bu butonu sadece <@&${botlistadmin}> yetkisi olanlar kullanabilir!`, ephemeral: true})
            ...
            if (!interaction.member.roles.cache.has(botlistadmin)) return interaction.reply({ content: "❌ | Bu işlemi gerçekleştirmek için <@&" + botlistadmin + "> rolüne sahip olmalısın!", ephemeral: true })
        ...
        const embed = new Discord.EmbedBuilder()
        .setAuthor({ name: "Stars Team Destek Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
        ...
        .setColor('Blue')
          ...
          if(find) {
            ...
            .setDescription(`❌ Zaten bir talebin bulunmakta.`)
...
if(interaction.customId === `benıdogrula_everyone_${interaction.guild.id}${interaction.user.id}`)
      ...
      await interaction.showModal(giriscikismodal);
        ...
        if(interaction.customId === `giriscikismesajsifirla_`+interaction.user.id) {
          ...
          .setColor(0x2F3136)
          .setAuthor({ name: `${interaction.user.tag}`, iconURL: `${interaction.user.displayAvatarURL()} ` })
          .setDescription("✅ **|** Giriş çıkış mesajı sıfırlandı!")
